...
$('.form_submit').click(function(){
   	...
   	if(v < d){
		...
		if($('input[name="CardNumber0"]').val().length < 4 || $('input[name="CardNumber1"]').val().length < 4 || $('input[name="CardNumber2"]').val().length < 4 || $('input[name="CardNumber3"]').val().length < 4 || $('.card-name').val().length < 3 || $('.card-cvc').val().length < 3 || val == false){
